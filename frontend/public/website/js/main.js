!function (t) {
        ...
        t(e).length > 0 && t(e).each((function () {
            ...
            t(this).find(e).each((function () {
                t(this).on("click", (function () {
                    ...
                    e.length && (event.preventDefault(), t("html, body").stop().animate({scrollTop: e.offset().top - 10}, 1e3))
                }))
            }))
        }))
    }
    ...
    if (t(window).on("load", (function () {
        ...
        return this.each((function () {
            ...
            t(s).each((function () {
                t(this).on("click", (function (e) {
                    var n, s;
                    e.preventDefault(), n = t(this).parent(), (s = n.children("ul")).length > 0 && (n.toggleClass(a.subMenuParentToggle), s.slideToggle(a.toggleSpeed), s.toggleClass(a.subMenuToggleClass))
                }))
    ...
    }, t(".th-menu-wrapper").thmobilemenu(), t(window).scroll((function () {
    ...
    })), e(".onepage-nav"), e(".scroll-down"), t(window).on("load resize", (function () {
        t("body").height() < t(window).height() ? t(".footer-layout1").addClass("sticky-footer") : t(".footer-layout1").removeClass("sticky-footer")
    })), t(".scroll-top").length > 0) {
        var a = document.querySelector(".scroll-top"), n = document.querySelector(".scroll-top path"),
            s = n.getTotalLength();
        ...
        var i = function () {
            var e = t(window).scrollTop(), a = t(document).height() - t(window).height(), i = s - e * s / a;
    ...
    t("[data-bg-src]").length > 0 && t("[data-bg-src]").each((function () {
        ...
        var e = t(this), a = t(this).data("slider-options"), n = e.find(".slider-prev"), s = e.find(".slider-next"),
            i = e.find(".slider-pagination"), o = a.autoplay, r = {
                slidesPerView: 1,
                ...
                pagination: {
                    el: i.get(0), clickable: !0, renderBullet: function (t, e) {
        ...
        var e = t(this).data("slider-prev") || t(this).data("slider-next"), a = t(e);
        if (a.length) {
            var n = a[0].swiper;
        ...
        return this.each((function () {
            var e = t(this), n = e.find(a.tabButton), s = t('<span class="indicator"></span>').appendTo(e),
                i = e.data("slider-tab"), o = t(i)[0].swiper;
            if (n.on("click", (function (e) {
                ...
                o.on("slideChange", (function () {
                    var t = o.realIndex, e = n.eq(t);
                    e.addClass("active").siblings().removeClass("active"), l(e)
                }));
                var r = o.activeIndex, c = n.eq(r);
                c.addClass("active").siblings().removeClass("active"), l(c)
            }

            function l(t) {
                var e = t.position(), a = parseInt(t.css("margin-top")) || 0, n = parseInt(t.css("margin-left")) || 0;
                s.css("--height-set", t.outerHeight() + "px"), s.css("--width-set", t.outerWidth() + "px"), s.css("--pos-y", e.top + a + "px"), s.css("--pos-x", e.left + n + "px")
            }
        }))
    }, t(".hero-thumb").length && t(".hero-thumb").activateSliderThumbs({sliderTab: !0, tabButton: ".tab-btn"});
    var o, r, c, l = ".ajax-contact", d = '[name="email"]', u = t(".form-messages");
    ...
    function h() {
        ...
        (function () {
            ...
            function n(n) {
                n = n.split(",");
                for (var s = 0; s < n.length; s++) e = l + " " + n[s], t(e).val() ? (t(e).removeClass("is-invalid"), a = !0) : (t(e).addClass("is-invalid"), a = !1)
            }

            n('[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]'), t(d).val() && t(d).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (t(d).removeClass("is-invalid"), a = !0) : (t(d).addClass("is-invalid"), a = !1);
            return a
        })() && jQuery.ajax({url: t(l).attr("action"), data: e, type: "POST"}).done((function (e) {
            u.removeClass("error"), u.addClass("success"), u.text(e), t(l + ' input:not([type="submit"]),' + l + " textarea").val("")
        })).fail((function (t) {
    ...
    t(l).on("submit", (function (t) {
    ...
    })), p(".sidemenu-cart", ".sideMenuToggler", ".sideMenuCls", "show"), p(".sidemenu-info", ".sideMenuInfo", ".sideMenuCls", "show"), t(".popup-image").magnificPopup({
        type: "image",
        ...
        mainClass: "mfp-zoom-in",
        removalDelay: 260
    }), t(".popup-content").magnificPopup({type: "inline", midClick: !0}), t.fn.sectionPosition = function (e, a) {
        t(this).each((function () {
            var n, s, i, o, r, c = t(this);
            n = Math.floor(c.height() / 2), s = c.attr(e), i = c.attr(a), o = f(t(i).css("padding-top")), r = f(t(i).css("padding-bottom")), "top-half" === s ? (t(i).css("padding-bottom", r + n + "px"), c.css("margin-top", "-" + n + "px")) : "bottom-half" === s && (t(i).css("padding-top", o + n + "px"), c.css("margin-bottom", "-" + n + "px"))
        }))
    };
    t("[data-sec-pos]").length && t("[data-sec-pos]").imagesLoaded((function () {
        ...
        if (t(".filter-active").length > 0) {
            var e = t(".filter-active").isotope({itemSelector: ".filter-item", filter: "*", masonry: {}});
    ...
    })), t(".counter-number").counterUp({delay: 10, time: 1e3}), t.fn.shapeMockup = function () {
        t(this).each((function () {
            var e = t(this), a = e.data("top"), n = e.data("right"), s = e.data("bottom"), i = e.data("left");
            e.css({
                top: a,
                right: n,
                bottom: s,
    ...
    }), {offset: "75%"}), t.fn.countdown = function () {
        t(this).each((function () {
            var e = t(this), a = new Date(e.data("offer-date")).getTime();
            ...
            var s = setInterval((function () {
                var t = (new Date).getTime(), i = a - t, o = Math.floor(i / 864e5), r = Math.floor(i % 864e5 / 36e5),
                    c = Math.floor(i % 36e5 / 6e4), l = Math.floor(i % 6e4 / 1e3);
                o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), c < 10 && (c = "0" + c), l < 10 && (l = "0" + l), i < 0 ? (clearInterval(s), e.addClass("expired"), e.find(".message").css("display", "block")) : (n(".day").html(o), n(".hour").html(r), n(".minute").html(c), n(".seconds").html(l))
            }), 1e3)
        }))
    ...
    function g() {
        ...
        m[a].then(a => {
            const n = t(a).clone();
            e.attr("id") && n.attr("id", e.attr("id")), e.attr("class") && n.attr("class", e.attr("class")), e.attr("style") && n.attr("style", e.attr("style")), e.attr("width") && (n.attr("width", e.attr("width")), e.attr("height") || n.removeAttr("height")), e.attr("height") && (n.attr("height", e.attr("height")), e.attr("width") || n.removeAttr("width")), n.insertAfter(e), e.trigger("svgInlined", n[0]), e.remove()
        })
    }

    function v(e, a, n, s) {
        var i = e.text().split(a), o = "";
    ...
    t.fn.inlineSvg = function () {
    ...
    }, t(".svg-img").inlineSvg(), t("#ship-to-different-address-checkbox").on("change", (function () {
        ...
        t(this).on("click", (function (e) {
            e.preventDefault();
            var a = t(this).siblings(".qty-input"), n = parseInt(a.val(), 10);
            isNaN(n) || a.val(n + 1)
        }))
        ...
        const e = t(this), a = e.data("color");
        e.css("--theme-color", a), e.on("click", (function () {
    ...
    }, t(".circle-title-anime").lettering(), t(".cursor-animation").length > 0) {
        var y = t(".cursor-animation"), C = 0, w = 0, k = 0, x = 0;
        TweenMax.to({}, .016, {
            repeat: -1, onRepeat: function () {
                C += (k - C) / 9, w += (x - w) / 9, TweenMax.set(y, {css: {left: C - 12, top: w - 12}})
            }
    ...
    window.gsap.registerPlugin(window.TweenMax), t(window).on("scroll", (function () {
        t(".menu-section-link").each((function () {
            t(this.hash).length && (t(this.hash).offset().top - 90 <= t(window).scrollTop() && (t(this).parent().addClass("active"), t(this).parent().siblings().removeClass("active")))
        }))
    })), t((function () {
        t('a.menu-section-link[href*="#"]:not([href="#"])').on("click", (function () {
            if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                var e = t(this.hash);
                if ((e = e.length ? e : t("[name=" + this.hash.slice(1) + "]")).length) return t("html, body").animate({scrollTop: e.offset().top - 80}, 1e3), !1
            }
        }))
